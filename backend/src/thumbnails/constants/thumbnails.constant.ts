...
export const COLOR_SCHEME_DESCRIPTIONS = {
  vibrant:
    'vibrant colors, highly saturated, colorful, bright tones, strong contrast',

  sunset:
    'warm sunset palette, orange, pink, red, golden tones, soft gradient lighting',

  forest:
    'natural forest colors, green tones, earthy browns, organic and calm palette',

  neon: 'neon colors, glowing lights, electric blue, hot pink, purple highlights, dark background',

  purple:
    'purple dominant palette, violet, lavender, deep purple tones, soft glow',
  ...
  pastel:
    'pastel colors, soft tones, light pink, baby blue, mint green, smooth and gentle look',
};
