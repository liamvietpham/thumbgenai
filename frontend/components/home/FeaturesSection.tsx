...
import FeatureEditableIcon from '@/components/icons/generated/FeatureEditableIcon';
import FeatureEyeCatchingIcon from '@/components/icons/generated/FeatureEyeCatchingIcon';
import FeatureSmartAnalysisIcon from '@/components/icons/generated/FeatureSmartAnalysisIcon';
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          <div className="md:col-span-2">
            <div className="relative overflow-hidden rounded-[28px] border-2 border-[#255fbe] shadow-[0_16px_38px_rgba(30,58,100,0.2)] transition duration-300 hover:-translate-y-0.5">
              <Image
              ...
              <div className="pointer-events-none absolute right-0 top-[36%] w-[44%] rounded-l-2xl border border-white/45 bg-white/55 px-3 py-2 text-white shadow-[0_12px_30px_rgba(20,32,60,0.2)] backdrop-blur-sm sm:top-[35%] sm:w-[40%] sm:px-7 sm:py-5">
              ...
              <div className="pointer-events-none absolute bottom-[10%] right-0 w-[80%] rounded-l-2xl rounded-r-none bg-[#255fbe] p-4 text-white shadow-[0_12px_24px_rgba(15,87,234,0.35)] sm:w-[88%] sm:p-8">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex -space-x-1.5 sm:-space-x-2">
                    <Image
                      ...
                      width={36}
                      height={36}
                      sizes="(max-width: 640px) 2rem, 2.25rem"
                      unoptimized
          ...
          <div className="md:col-span-1">
            <div className="mx-auto h-67.5 w-full max-w-90 overflow-hidden rounded-[28px] border border-[#4c7fd2] bg-linear-to-b from-[#1a3470] via-[#1f4e97] to-[#2f79d7] pl-8 pt-10 shadow-[0_16px_30px_rgba(31,67,126,0.24)] transition duration-300 hover:-translate-y-0.5 md:max-w-none">
