  ...
  return (
    <section className="px-6 pb-6 pt-20 md:px-8 md:pt-32">
      <div className="mx-auto max-w-7xl text-center">
        ...
        <div className="mt-10 inline-flex items-center gap-4 rounded-2xl border border-[var(--outline-variant)] bg-[var(--surface-container-low)] px-5 py-4 shadow-sm">
          <div className="flex items-center gap-2.5">
            <div className="hidden size-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#0058be] to-[#2170e4] text-white shadow sm:flex">
            ...
            <span className="font-headline text-base font-bold text-[var(--on-surface)]">1 Credit</span>
          </div>

          <span className="text-lg font-bold text-[var(--on-surface-variant)]">=</span>

          <div className="flex items-center gap-2.5">
            <div className="hidden size-9 shrink-0 items-center justify-center rounded-lg bg-[var(--tertiary-fixed)] text-[var(--on-tertiary-fixed-variant)] shadow sm:flex">
              <svg aria-hidden="true" className="size-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2ZM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5Z" />
              </svg>
            </div>
            <span className="font-headline text-base font-bold text-[var(--on-surface)]">1 High-Quality Thumbnail</span>
          </div>
        </div>
      </div>
    </section>
