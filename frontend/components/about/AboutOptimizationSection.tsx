...
export function AboutOptimizationSection() {
  return (
    <section className="px-6 py-12 md:px-8 md:py-40">
      <div className="mx-auto max-w-7xl rounded-[2rem] border border-[rgba(194,198,214,0.16)] bg-(--surface-container-lowest) p-6 shadow-[0_32px_64px_-12px_rgba(0,88,190,0.04)] md:rounded-[2.5rem] md:p-20">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center lg:gap-16">
          <div className="lg:col-span-7">
            <div className="mb-6 flex items-center gap-4">
              <div className="grid size-10 place-items-center rounded-full bg-[rgba(0,88,190,0.10)] text-(--primary)">
            ...
            <div className="mt-10 grid gap-8 md:grid-cols-2">
              {optimizationCards.map((card) => {
                ...
                return (
                  <article
                    key={card.title}
                    className="rounded-[1.5rem] border border-[rgba(194,198,214,0.18)] bg-(--surface-container-low) p-6"
                  >
          ...
          <figure className="relative lg:col-span-5">
            <div className="relative overflow-hidden rounded-[1.75rem] shadow-2xl">
              <div className="pointer-events-none absolute inset-0 z-10 bg-linear-to-tr from-[rgba(0,88,190,0.20)] to-[rgba(87,223,254,0.10)]" />
              <Image
              ...
              <figcaption className="absolute bottom-6 left-6 right-6 z-20 rounded-[1.25rem] border border-white/30 bg-white/80 p-4 backdrop-blur-md">
                ...
                <div className="h-1.5 w-full overflow-hidden rounded-full bg-slate-200">
                  <div className="h-full w-[94.8%] rounded-full bg-linear-to-r from-[#0058be] to-[#2170e4]" />
                </div>
              </figcaption>
            </div>
          </figure>
