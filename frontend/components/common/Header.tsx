...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-linear-to-b from-[#cfe0fa]/95 to-[#bdd3f5]/92 backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4">
        ...
        <div ref={mobileRef} className="relative md:hidden">
          <button
            onClick={() => setOpen((v) => !v)}
            className="inline-flex size-10 items-center justify-center rounded-md border border-[#6f93c8] bg-[#c8daf6] text-[#2f5ea5]"
