  ...
  return (
    <main className="mx-auto max-w-4xl px-6 pb-24 pt-16 md:px-8 md:pt-24">
      <section className="mb-16 space-y-6">
        <div className="inline-flex items-center gap-2 rounded-full bg-[rgba(63,103,0,0.10)] px-3 py-1 text-xs font-bold uppercase tracking-wider text-[var(--tertiary)]">
          <LockIcon className="size-3.5" />
          Legal Framework
        </div>

        <h1 className="font-headline text-5xl font-bold tracking-tight text-[var(--on-surface)] md:text-6xl">
          Terms of <span className="text-[var(--primary)]">Service</span>
        </h1>

        <p className="max-w-2xl text-xl leading-relaxed text-[var(--on-surface-variant)]">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[var(--surface-container-lowest)] px-5 py-2 text-sm font-medium text-[var(--primary)] shadow-sm tonal-transition hover:shadow-md"
          >
      ...
      <div className="h-px bg-gradient-to-r from-[rgba(194,198,214,0.6)] via-[rgba(194,198,214,0.3)] to-transparent" />
