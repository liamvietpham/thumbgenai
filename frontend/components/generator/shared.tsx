...
export function PreviewPanel({
  ...
  return (
    <div className="h-fit rounded-2xl border border-[#8eaedf] bg-[#dbe8fb]/75 p-6 shadow-xl">
      ...
      <div className="relative mx-auto w-full max-w-2xl">
        <div className="relative w-full overflow-hidden" style={{ aspectRatio: aspect }}>
          {hasResult && imageUrl ? (
            ...
            <div className="absolute inset-0 m-2 flex flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-[#8eaedf] bg-[#bcd0ef]/35">
              <div className="hidden size-20 items-center justify-center rounded-full bg-[#dbe8fb]/70 max-sm:hidden sm:flex">
                <PlaceholderImageIcon className="size-10 text-[#6b88b5]" aria-hidden="true" />
              </div>
          ...
          {isLoading ? (
            <div className="absolute inset-0 z-10 m-2 flex items-center justify-center rounded-lg bg-[radial-gradient(circle_at_top,rgba(75,11,25,0.75),rgba(5,7,16,0.95))]">
              <div className="flex flex-col items-center px-6 text-center">
                <SpinnerIcon className="mb-6 size-11 animate-spin text-white/80" aria-hidden="true" />
