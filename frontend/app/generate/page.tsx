...
export default function GeneratePage() {
  ...
  const getStyleIcon = (icon: (typeof styleOptions)[number]['icon']) => {
    if (icon === 'spark') {
      return <SparkIcon className="size-5" />;
    }
    if (icon === 'square') {
    ...
    if (icon === 'pen') {
      return <PenIcon className="size-5" />;
    }
              ...
              <div className="space-y-5">
                ...
                <div ref={styleRef} className="relative space-y-3">
                  ...
                  >
                    ...
                    <ChevronDownIcon
                      className={`size-5 text-[#6b88b5] transition-transform ${styleOpen ? 'rotate-180' : ''}`}
                    />
                  </button>
                ...
                <div ref={modelRef} className="relative space-y-2">
                  ...
                  >
                    ...
                    <ChevronDownIcon
                      className={`size-5 text-[#6b88b5] transition-transform ${modelOpen ? 'rotate-180' : ''}`}
                    />
                  </button>
