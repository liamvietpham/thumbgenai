        ...
        {visibleItems.map((item) => (
          ...
          >
            ...
            <div className="absolute bottom-2 right-2 flex gap-1.5 max-sm:flex sm:hidden group-hover:flex">
              <button
                type="button"
                className="flex size-6 cursor-pointer items-center justify-center rounded bg-black/50 text-white transition-all hover:bg-[#2f5ea5]"
                onClick={async () => {
              ...
              <Link
                target="_blank"
                href={item.imageUrl}
                className="flex size-6 items-center justify-center rounded bg-black/50 text-white transition-all hover:bg-[#2f5ea5]"
